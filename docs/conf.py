...
latex_documents = [
    (master_doc, 'Noisify.tex', 'Noisify Documentation',
     'Declan Crew', 'manual'),
]
...
man_pages = [
    (master_doc, 'noisify', 'Noisify Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Noisify', 'Noisify Documentation',
     author, 'Noisify', 'One line description of project.',
     'Miscellaneous'),
]
